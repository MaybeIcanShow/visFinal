/* @preserve Leaflet 1.2.0, a JS library for interactive maps.
 * http://leafletjs.com (c) 2010-2017 Vladimir Agafonkin, (c) 2010-2011
 * CloudMade
 */
!function (t, i) {
    ...
    function y(t) {
        if (L && L.Mixin) {
            ...
            for (var i = 0; i < t.length; i++) 
                t[i] === L.Mixin.Events && console.warn(
                    "Deprecated include of L.Mixin.Events: this property will be removed in future " +
                            "releases, please inherit from L.Evented instead.",
                    (new Error).stack
                )
        }
    }
    ...
    var Qt = Object.create || function () {
        ...
        ri = window.cancelAnimationFrame || p("CancelAnimationFrame") || p(
    ...
    v.extend = function (t) {
        ...
        e.prototype = o;
        for (var s in this) 
            this.hasOwnProperty(s) && "prototype" !== s && "__super__" !== s && (
                e[s] = this[s]
            );
        return t.statics && (i(e, t.statics), delete t.statics),
        t.includes && (
            y(t.includes),
    ...
    P.prototype = {
        ...
        contains: function (t) {
            var i,
                e;
            return (
                t = "number" == typeof t[0] || t instanceof x
                    ? w(t)
                    : b(t)
            )instanceof P
                ? (i = t.min, e = t.max)
    ...
    T.prototype = {
        ...
        contains: function (t) {
            t = "number" == typeof t[0] || t instanceof M || "lat" in t
                ? C(t)
                : z(t);
            var i,
                e,
    ...
    var li = {
            ...
            wrapLatLng: function (t) {
                var i = this.wrapLng
                    ? s(t.lng, this.wrapLng, !0)
                    : t.lng;
                return new M(
                    this.wrapLat
                        ? s(t.lat, this.wrapLat, !0)
                        : t.lat,
                    i,
                    t.alt
                )
        ...
        ci = i({}, li, {
            ...
            distance: function (t, i) {
                var e = Math.PI / 180,
                    n = t.lat * e,
                    o = i.lat * e,
                    s = Math.sin(n) * Math.sin(o) + Math.cos(n) * Math.cos(o) * Math.cos(
                        (i.lng - t.lng) * e
                    );
    ...
    var di,
        ...
        Hi = !window.L_NO_TOUCH && (
            Wi || "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch
        ),
        Fi = Ri && zi,
        Ui = Ri && Ci,
        Vi = (
        ...
        de = "webkitTransition" === _e || "OTransition" === _e
            ? _e + "End"
            : "transitionend";
    ...
    var me,
        ...
        ye = ui.extend({
            ...
            panBy: function (t, i) {
                ...
                if (this._panAnim || (this._panAnim = new ve, this._panAnim.on({
                    ...
                    this
                        ._panAnim
                        .run(this._mapPane, e, i.duration || .25, i.easeLinearity)
                } else 
                    this._rawPanBy(t),
                    this
                        .fire("move")
            ...
            flyTo: function (t, i, e) {
                ...
                function l() {
                    var e = (Date.now() - L) / b,
                        n = u(e) * P;
                    e <= 1
                        ? (this._flyToFrame = f(l, this), this._move(
            ...
            locate: function (t) {
                ...
                return t.watch
                    ? this._locationWatchId = navigator
                        .geolocation
                        .watchPosition(n, o, t)
                    : navigator
                        .geolocation
                        .getCurrentPosition(n, o, t),
                this
            },
            stopLocate: function () {
                return navigator.geolocation && navigator.geolocation.clearWatch && navigator
                    .geolocation
                    .clearWatch(this._locationWatchId),
            ...
            _initEvents: function (t) {
                ...
                i(
                    this._container,
                    "click dblclick mousedown mouseup mouseover mouseout mousemove contextmenu keyp" +
                            "ress",
                    this._handleDOMEvent,
                    this
                ),
                this.options.trackResize && i(window, "resize", this._onResize, this),
                Oi && this.options.transform3DLimit && (
                    t
                        ? this.off
                        : this.on
            ...
            _draggableMoved: function (t) {
                return (
                    t = t.dragging && t.dragging.enabled()
                        ? t
                        : this
                ).dragging && t
                    .dragging
                    .moved() || this.boxZoom && this
                    .boxZoom
                    .moved()
            },
            ...
            _latLngBoundsToNewLayerBounds: function (t, i, e) {
                ...
                return b([
                    this
                        .project(t.getSouthWest(), i)
                        ._subtract(n),
                    this
                        .project(t.getNorthWest(), i)
                        ._subtract(n),
                    this
                        .project(t.getSouthEast(), i)
                        ._subtract(n),
                    this
                        .project(t.getNorthEast(), i)
                        ._subtract(n)
                ])
            },
            ...
            _tryAnimatedPan: function (t, i) {
                var e = this
                    ._getCenterOffset(t)
                    ._floor();
                return !(!0 !== (i && i.animate) && !this.getSize().contains(e)) && (
                    this.panBy(e, i),
                    !0
                )
            },
            _createAnimProxy: function () {
                ...
                this.on("zoomanim", function (t) {
                    ...
                    e === this
                        ._proxy
                        .style[i] && this._animatingZoom && this._onZoomTransitionEnd()
                }, this),
            ...
            _catchTransitionEnd: function (t) {
                this._animatingZoom && t
                    .propertyName
                    .indexOf("transform") >= 0 && this._onZoomTransitionEnd()
            },
            _nothingToAnimate: function () {
                return !this
                    ._container
                    .getElementsByClassName("leaflet-zoom-animated")
                    .length
            },
        ...
        xe = v.extend({
            ...
            _refocusOnMap: function (t) {
                this._map && t && t.screenX > 0 && t.screenY > 0 && this
                    ._map
                    .getContainer()
                    .focus()
            }
    ...
    var Le = xe.extend({
            ...
            onAdd: function (t) {
                ...
                for (var i = 0; i < this._layers.length; i++) 
                    this
                        ._layers[i]
                        .layer
                        .on("add remove", this._onLayerChange, this);
                return this._container
            },
            addTo: function (t) {
                return xe
            ...
            removeLayer: function (t) {
                ...
                return i && this
                    ._layers
                    .splice(this._layers.indexOf(i), 1),
                this._map
                    ? this._update()
                    : this
            },
            ...
            _initLayout: function () {
                ...
                e && (this._map.on("click", this.collapse, this), bi || V(i, {
            ...
            _addLayer: function (t, i, n) {
                ...
                this
                    ._layers
                    .push({layer: t, name: i, overlay: n}),
                this.options.sortLayers && this
                    ._layers
                    .sort(e(function (t, i) {
                        return this
                            .options
                            .sortFunction(t.layer, i.layer, t.name, i.name)
                    }, this)),
            ...
            _update: function () {
                ...
                this._separator.style.display = i && t
                    ? ""
                    : "none",
                this
            },
        ...
        Pe = xe.extend({
            ...
            _zoomIn: function (t) {
                !this._disabled && this._map._zoom < this
                    ._map
                    .getMaxZoom() && this
                    ._map
                    .zoomIn(this._map.options.zoomDelta * (
                        t.shiftKey
                            ? 3
                            : 1
                    ))
            ...
            _zoomOut: function (t) {
                !this._disabled && this._map._zoom > this
                    ...
                    .getMinZoom() && this
                    ._map
                    .zoomOut(this._map.options.zoomDelta * (
                        t.shiftKey
                            ? 3
                            : 1
                    ))
    ...
    var be = xe.extend({
        ...
        Te = xe.extend({
            options: {
                ...
                prefix: '<a href="http://leafletjs.com" title="A JS library for interactive maps">Leafl' +
                        'et</a>'
            },
            initialize: function (t) {
                l(this, t),
    ...
    var ze,
        ...
        ke = ui.extend({
            ...
            enable: function () {
                this._enabled || (
                    V(this._dragStartTarget, Ze, this._onDown, this),
                    this._enabled = !0
                )
            },
            disable: function () {
            ...
            _onDown: function (t) {
                if (!t._simulated && this._enabled && (
                    this._moved = !1,
                    !dt(this._element, "leaflet-zoom-anim") && !(ke._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || (
                        ke._dragging = this,
            ...
            _onMove: function (t) {
                if (!t._simulated && this._enabled) 
                    if (t.touches && t.touches.length > 1) 
                        ...
                        var i = t.touches && 1 === t.touches.length
                                ? t.touches[0]
                                : t,
            ...
            finishDrag: function () {
                ...
                Tt(),
                mi(),
                this._moved && this._moving && (g(this._animRequest), this.fire("dragend", {
                    distance: this
                        ._newPos
                        .distanceTo(this._startPos)
                })),
                this._moving = !1,
                ke._dragging = !1
            }
        ...
        Re = (Object.freeze || Object)(
            {LonLat: Ae, Mercator: Oe, SphericalMercator: _i}
        ),
        De = i({}, ci, {
            code: "EPSG:3395",
            projection: Oe,
    ...
    var We = ui.extend({
        ...
        _layerAdd: function (t) {
            ...
            if (i.hasLayer(this)) {
                ...
                this.onAdd(i),
                this.getAttribution && i.attributionControl && i
                    .attributionControl
                    .addAttribution(this.getAttribution()),
                this.fire("add"),
    ...
    ye.include({
        ...
        _removeZoomLimit: function (t) {
            ...
            this._zoomBoundLayers[i] && (
                delete this._zoomBoundLayers[i],
                this._updateZoomLevels()
            )
        },
        _updateZoomLevels: function () {
            ...
            this._layersMaxZoom = i === -1 / 0
                ? void 0
                : i,
            this._layersMinZoom = t === 1 / 0
                ? void 0
                : t,
            e !== this._getZoomSpan() && this.fire("zoomlevelschange"),
            void 0 === this.options.maxZoom && this._layersMaxZoom && this.getZoom() > this._layersMaxZoom && this.setZoom(
                this._layersMaxZoom
            ),
            void 0 === this.options.minZoom && this._layersMinZoom && this.getZoom() < this._layersMinZoom && this.setZoom(
                this._layersMinZoom
            )
        }
    });
    var He = We.extend({
            ...
            removeLayer: function (t) {
                var i = t in this._layers
                    ? t
                    : this.getLayerId(t);
                return this._map && this._layers[i] && this
                    ._map
        ...
        Ue = v.extend({
            ...
            _setIconStyles: function (t, i) {
                ...
                var o = w(n),
                    s = w(
                        "shadow" === i && e.shadowAnchor || e.iconAnchor || o && o.divideBy(2, !0)
                    );
                t.className = "leaflet-marker-" + i + " " + (
                    e.className || ""
                ),
        ...
        Ve = Ue.extend({
            ...
            _getIconUrl: function (t) {
                ...
                (this.options.imagePath || Ve.imagePath) + Ue
                    .prototype
                    ._getIconUrl
                    .call(this, t)
            },
        ...
        qe = We.extend({
            ...
            onRemove: function (t) {
                this.dragging && this
                    .dragging
                    .enabled() && (this.options.draggable = !0, this.dragging.removeHooks()),
        ...
        Ye = Ke.extend({
            ...
            _empty: function () {
                return this._radius && !this
                    ._renderer
                    ._bounds
                    .intersects(this._pxBounds)
            },
        ...
        Xe = Ye.extend({
            ...
            getBounds: function () {
                var t = [
                    this._radius, this._radiusY || this._radius
                ];
                return new T(
                ...
                if (n.distance === ci.distance) {
                    var o = Math.PI / 180,
                        ...
                        u = e
                            ...
                            .lat,
                        l = Math.acos(
                            (Math.cos(s * o) - Math.sin(i * o) * Math.sin(u * o)) / (Math.cos(i * o) * Math.cos(u * o))
                        ) / o;
                    (isNaN(l) || 0 === l) && (l = s / Math.cos(Math.PI / 180 * i)),
                    this._point = h.subtract(e.getPixelOrigin()),
                    this._radius = isNaN(l)
                        ? 0
                        : Math.max(Math.round(h.x - e.project([
                            u, t - l
                        ]).x), 1),
        ...
        Je = Ke.extend({
            ...
            _projectLatlngs: function (t, i, e) {
                var n,
                    o,
                    s = t[0] instanceof M, r = t.length;
                if (s) {
                    for (o = [], n = 0; n < r; n++) 
                        o[n] = this
                            ._map
                            .latLngToLayerPoint(t[n]),
                        e.extend(o[n]);
                    i.push(o)
                } else 
                    for (n = 0; n < r; n++) 
    ...
    var $e = Je.extend({
            ...
            isEmpty: function () {
                return !this._latlngs.length || !this
                    ._latlngs[0]
                    .length
            },
            getCenter: function () {
                ...
                if (
                    ...
                    if (this.options.noClip) 
                        ...
                        for (var n, o = 0, s = this._rings.length; o < s; o++) 
                            (n = jt(this._rings[o], t, !0)).length && this
                                ._parts
                                .push(n)
                },
            _updatePath: function () {
            ...
            _containsPoint: function (t) {
                ...
                for (o = 0, a = this._parts.length; o < a; o++) 
                    for (s = 0, r = (h = (i = this._parts[o]).length) - 1; s < h; r = s++) 
                        e = i[s],
                        n = i[r],
                        e.y > t.y != n.y > t.y && t.x < (n.x - e.x) * (t.y - e.y) / (n.y - e.y) + e.x && (
                            u = !u
                        );
            return u || Je
                    .prototype
            ...
            addData: function (t) {
                ...
                if (o) {
                    for (i = 0, e = o.length; i < e; i++) 
                        ((n = o[i]).geometries || n.geometry || n.features || n.coordinates) && this.addData(
                            n
                        );
                    return this
                }
    ...
    var en = Kt,
        nn = We.extend({
            ...
            _initImage: function () {
                var t = this._image = ht("img", "leaflet-image-layer " + (
                    this._zoomAnimated
            ...
            _animateZoom: function (t) {
                var i = this
                    ...
                    e = this
                        ._map
                        ._latLngBoundsToNewLayerBounds(this._bounds, t.zoom, t.center)
                        .min;
                wt(this._image, e, i)
            },
            _reset: function () {
            ...
            _updateZIndex: function () {
                this._image && void 0 !== this.options.zIndex && null !== this.options.zIndex && (
            ...
            _updateContent: function () {
                if (this._content) {
                    var t = this._contentNode,
                        i = "function" == typeof this._content
    ...
    We.include({
        bindTooltip: function (t, i) {
            ...
            this._tooltip.options.permanent && this._map && this
                ._map
                .hasLayer(this) && this.openTooltip(),
            this
        },
        ...
        openTooltip: function (t, i) {
            ...
            this._tooltip && this._map && (
                ...
                this._tooltip.options.interactive && this._tooltip._container && (
        ...
        _openTooltip: function (t) {
            var i = t.layer || t.target;
            this._tooltip && this._map && this.openTooltip(
                i,
    ...
    var hn = Ue.extend({
        ...
        createIcon: function (t) {
            var i = t && "DIV" === t.tagName
                    ? t
                    : document.createElement("div"),
                e = this.options;
            if (
                i.innerHTML = !1 !== e.html
                    ? e.html
                    : "",
                e.bgPos
            ) {
    ...
    var un = We.extend({
            ...
            bringToBack: function () {
                return this._map && (_t(this._container), this._setAutoZIndex(Math.min)),
                this
            },
            getContainer: function () {
                return this._container
            ...
            _initContainer: function () {
                this._container || (
                    this._container = ht("div", "leaflet-layer " + (
                        this.options.className || ""
                    )),
                    this._updateZIndex(),
                    this.options.opacity < 1 && this._updateOpacity(),
                    ...
                    if (e > this.options.maxZoom || e < this.options.minZoom) 
                        ...
                        for (t in this._tiles) 
                            if ((i = this._tiles[t]).current && !i.active) {
                                var n = i.coords;
                                this._retainParent(n.x, n.y, n.z, n.z - 5) || this._retainChildren(
                                    n.x,
                                    n.y,
                                    n.z,
                                    n.z + 2
            ...
            _resetGrid: function () {
                var t = this._map,
                    ...
                    o = this
                        ._map
                        .getPixelWorldBounds(this._tileZoom);
                ...
                if (i) {
                    ...
                    if (void 0 === t && (t = i.getCenter()), void 0 !== this._tileZoom) {
                        var n = this._getTiledPixelBounds(t),
                            ...
                            h = new P(o.getBottomLeft().subtract([
                                a, -a
                            ]), o.getTopRight().add([
                                a, -a
                            ]));
            ...
            _tileReady: function (t, i, n) {
                if (this._map) {
                    ...
                    (n = this._tiles[o]) && (
                        ...
                        i || (pt(n.el, "leaflet-tile-loaded"), this.fire("tileload", {
                            tile: n.el,
                            coords: t
                        })),
                        this._noTilesToLoad() && (
        ...
        ln = un.extend({
            ...
            initialize: function (t, i) {
                this._url = t,
                (i = l(this, i)).detectRetina && Vi && i.maxZoom > 0 && (
            ...
            getTileUrl: function (t) {
                var i = this._tileCoordsToBounds(t),
                    ...
                    s = ln
                        ...
                        .getTileUrl
                        .call(this, t);
                return s + c(this.wmsParams, s, this.options.uppercase) + (
    ...
    var _n = We.extend({
            ...
            _updateTransform: function (t, i) {
                var e = this
                    ...
                    a = o
                        ...
                        .subtract(r);
                Oi
                    ? wt(this._container, a, e)
                    : Lt(this._container, a)
            },
            _reset: function () {
                this._update(),
        ...
        dn = _n.extend({
            ...
            _extendRedrawBounds: function (t) {
                if (t._pxBounds) {
                    ...
                    this
                        ._redrawBounds
                        .extend(t._pxBounds.min.subtract([i, i])),
                    this
                        ._redrawBounds
                        .extend(t._pxBounds.max.add([i, i]))
                }
            },
            _redraw: function () {
            ...
            _clear: function () {
                ...
                if (t) {
                    ...
                    this
                        ._ctx
                        .clearRect(t.min.x, t.min.y, i.x, i.y)
                } else 
                    this
                        ._ctx
                        .clearRect(0, 0, this._container.width, this._container.height)
                },
            _draw: function () {
                var t,
            ...
            _onClick: function (t) {
                for (
                    ...
                    (i = o.layer).options.interactive && i._containsPoint(n) && !this
                        ._map
                        ._draggableMoved(i) && (e = i);
        ...
        pn = function () {
            try {
                return document
                    .namespaces
                    .add("lvml", "urn:schemas-microsoft-com:vml"),
                function (t) {
    ...
    var vn = $e.extend({
        initialize: function (t, i) {
            $e
                .prototype
                .initialize
                .call(this, this._boundsToLatLngs(t), i)
        },
        setBounds: function (t) {
    ...
    var xn = Me.extend({
        addHooks: function () {
            this
                ._map
                .on("dblclick", this._onDoubleClick, this)
        },
        removeHooks: function () {
            this
                ._map
                .off("dblclick", this._onDoubleClick, this)
        },
    ...
    var wn = Me.extend({
        addHooks: function () {
            if (!this._draggable) {
                ...
                this
                    ._draggable
                    .on("predrag", this._onPreDragLimit, this),
        ...
        _onZoomEnd: function () {
            var t = this
                ...
                i = this
                    ._map
                    .latLngToLayerPoint([0, 0]);
            this._initialWorldOffset = i
                .subtract(t)
                .x,
            this._worldWidth = this
                ._map
                .getPixelWorldBounds()
                .getSize()
                .x
        ...
        _onPreDragLimit: function () {
            if (this._viscosity && this._offsetLimit) {
                var t = this
                        ._draggable
                        ._newPos
                        .subtract(this._draggable._startPos),
                    i = this._offsetLimit;
                t.x < i.min.x && (t.x = this._viscousLimit(t.x, i.min.x)),
                t.y < i.min.y && (t.y = this._viscousLimit(t.y, i.min.y)),
                t.x > i.max.x && (t.x = this._viscousLimit(t.x, i.max.x)),
                t.y > i.max.y && (t.y = this._viscousLimit(t.y, i.max.y)),
                this._draggable._newPos = this
                    ._draggable
                    ._startPos
                    .add(t)
            }
        ...
        _onPreDragWrap: function () {
            var t = this._worldWidth,
                ...
                o = (n - i + e) % t + i - e,
                s = (n + i + e) % t - i - e,
                r = Math.abs(o + e) < Math.abs(s + e)
                    ? o
                    : s;
            this._draggable._absPos = this
                ._draggable
                ._newPos
                .clone(),
            ...
            if (i.fire("dragend", t), n) 
                ...
                var o = this
                    ...
                    _ = l
                        ...
                        .round();
                _.x || _.y
                    ? (_ = i._limitOffset(_, i.options.maxBounds), f(function () {
                        i.panBy(_, {
                            duration: c,
                            easeLinearity: r,
                            noMoveStart: !0,
    ...
    var bn = Me.extend({
        ...
        _onDown: function (t) {
            if (t.touches) {
                ...
                n.tagName && "a" === n
                    .tagName
                    .toLowerCase() && pt(n, "leaflet-active"),
        ...
        _onUp: function (t) {
            if (clearTimeout(this._holdTimeout), G(document, {
                ...
                e && e.tagName && "a" === e
                    .tagName
                    .toLowerCase() && mt(e, "leaflet-active"),
        ...
        _isTapValid: function () {
            return this
                ._newPos
                .distanceTo(this._startPos) <= this._map.options.tapTolerance
        },
        _onMove: function (t) {
            var i = t.touches[0];
